...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtMinimumIntensityPercentageOfMaximum.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.txtMaximumPeaksToLabel.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.chkHideInDenseRegions.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.chkIncludeArrow.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.chkDisplayYPos.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.chkDisplayXPos.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.cboDataMode.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.txtThresholdMinimum.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.cmdAutoLabel.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.txtPeakWidthMinimum.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lblCaptionAngleLabel.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lblMininumIntensityInstructions.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lblPercentLabel.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lblMinimumIntensityFractionOfMaximum.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lblMaximumPeaksToLabel.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lblThresholdMinimum.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.lblPeakWidthMinimum.Font = New System.Drawing.Font("Arial", 8.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
...
#End Region
    ...
    Private Sub AutoLabelPeaks()
        ...
        With mCWGraphControl
            .SetPeakDetectIntensityThresholdCounts(StringToValueUtils.CDoubleSafe(txtThresholdMinimum.Text, 10))
            .SetPeakDetectIntensityThresholdPercentageOfMaximum(StringToValueUtils.CIntSafe(txtMinimumIntensityPercentageOfMaximum.Text, 0))
            .SetPeakDetectWidthPointsMinimum(StringToValueUtils.CDoubleSafe(txtPeakWidthMinimum.Text, 5))

            If cboDataMode.SelectedIndex = dmDataModeConstants.dmContinuous Then
                blnForceAsContinuousData = True
            Else
                blnForceAsDiscreteData = True
            End If

            .AutoLabelPeaks(cboSeriesNumber.SelectedIndex + 1, chkDisplayXPos.Checked, chkDisplayYPos.Checked, StringToValueUtils.CIntSafe(txtCaptionAngle.Text, 0), chkIncludeArrow.Checked, chkHideInDenseRegions.Checked, StringToValueUtils.CIntSafe(txtMaximumPeaksToLabel.Text, 1000), blnForceAsContinuousData, blnForceAsDiscreteData)
...
InitializeFormErrorHandler:
        Debug.WriteLine("Error occurred in frmAutoLabelPeaks.InitializeForm(): " & Err.Description)
        InitializeForm = False
    ...
    Private Sub PopulateComboBoxes()
        ...
        With cboDataMode
            ...
            .SelectedIndex = dmDataModeConstants.dmDiscrete
        End With
    ...
    Private Sub UpdateDataMode()
        ...
        If ePlotMode = CWGraphControl.pmPlotModeConstants.pmLines Or ePlotMode = CWGraphControl.pmPlotModeConstants.pmPointsAndLines Then
            ' Continuous data
            cboDataMode.SelectedIndex = dmDataModeConstants.dmContinuous
        Else
            cboDataMode.SelectedIndex = dmDataModeConstants.dmDiscrete
        End If

    End Sub

    Private Sub cboDataMode_SelectedIndexChanged(eventSender As Object, eventArgs As EventArgs) Handles cboDataMode.SelectedIndexChanged
        ShowHideOptions()
    End Sub
    ...
    Private Sub cmdAutoLabel_Click(eventSender As Object, eventArgs As EventArgs) Handles cmdAutoLabel.Click
        AutoLabelPeaks()
    End Sub
    ...
    Private Sub frmAutoLabelPeaks_Closed(eventSender As Object, eventArgs As EventArgs) Handles MyBase.Closed
    ...
    Private Sub txtCaptionAngle_KeyPress(eventSender As Object, eventArgs As KeyPressEventArgs) Handles txtCaptionAngle.KeyPress
        TextBoxUtils.TextBoxKeyPressHandler(txtCaptionAngle, eventArgs, True, False)
    End Sub
    ...
    Private Sub txtMaximumPeaksToLabel_Enter(eventSender As Object, eventArgs As EventArgs) Handles txtMaximumPeaksToLabel.Enter
        TextBoxGotFocusHandler(txtMaximumPeaksToLabel)
    End Sub

    Private Sub txtMaximumPeaksToLabel_KeyPress(eventSender As Object, eventArgs As KeyPressEventArgs) Handles txtMaximumPeaksToLabel.KeyPress
        TextBoxUtils.TextBoxKeyPressHandler(txtMaximumPeaksToLabel, eventArgs, True, False)
    End Sub

    Private Sub txtMaximumPeaksToLabel_Leave(eventSender As Object, eventArgs As EventArgs) Handles txtMaximumPeaksToLabel.Leave
        TextBoxUtils.ValidateTextBoxInt(txtMaximumPeaksToLabel, 0, 100000, 1000)
    End Sub

    Private Sub txtMinimumIntensityPercentageOfMaximum_Enter(eventSender As Object, eventArgs As EventArgs) Handles txtMinimumIntensityPercentageOfMaximum.Enter
        TextBoxGotFocusHandler(txtMinimumIntensityPercentageOfMaximum)
    End Sub

    Private Sub txtMinimumIntensityPercentageOfMaximum_KeyPress(eventSender As Object, eventArgs As KeyPressEventArgs) Handles txtMinimumIntensityPercentageOfMaximum.KeyPress
        TextBoxUtils.TextBoxKeyPressHandler(txtMinimumIntensityPercentageOfMaximum, eventArgs, True, False)
    End Sub

    Private Sub txtMinimumIntensityPercentageOfMaximum_Leave(eventSender As Object, eventArgs As EventArgs) Handles txtMinimumIntensityPercentageOfMaximum.Leave
        TextBoxUtils.ValidateTextBoxInt(txtMinimumIntensityPercentageOfMaximum, 0, 100, 0)
    End Sub

    Private Sub txtPeakWidthMinimum_Enter(eventSender As Object, eventArgs As EventArgs) Handles txtPeakWidthMinimum.Enter
        TextBoxGotFocusHandler(txtPeakWidthMinimum)
    End Sub

    Private Sub txtPeakWidthMinimum_KeyPress(eventSender As Object, eventArgs As KeyPressEventArgs) Handles txtPeakWidthMinimum.KeyPress
        TextBoxUtils.TextBoxKeyPressHandler(txtPeakWidthMinimum, eventArgs, True, False)
    End Sub

    Private Sub txtPeakWidthMinimum_Leave(eventSender As Object, eventArgs As EventArgs) Handles txtPeakWidthMinimum.Leave
        TextBoxUtils.ValidateTextBoxFloat(txtPeakWidthMinimum, 0, 100000000.0#, 5)
    End Sub

    Private Sub txtThresholdMinimum_Enter(eventSender As Object, eventArgs As EventArgs) Handles txtThresholdMinimum.Enter
        TextBoxGotFocusHandler(txtThresholdMinimum)
    End Sub

    Private Sub txtThresholdMinimum_KeyPress(eventSender As Object, eventArgs As KeyPressEventArgs) Handles txtThresholdMinimum.KeyPress
        TextBoxUtils.TextBoxKeyPressHandler(txtThresholdMinimum, eventArgs, True, True, True, False, True, False, False, False, False, True)
    End Sub

    Private Sub txtThresholdMinimum_Leave(eventSender As Object, eventArgs As EventArgs) Handles txtThresholdMinimum.Leave
